...
Сценарий: Открытие формы документа "Activity"
	...
	Дано Я открываю основную форму документа "Activity"
	Если появилось предупреждение Тогда
		Тогда я вызываю исключение "Не удалось открыть основную форму документа Activity"
	Если имя текущей формы "ErrorWindow" Тогда
		Тогда я вызываю исключение "Не удалось открыть основную форму документа Activity"
	И Я закрываю текущее окно
...
Сценарий: Открытие формы документа "Profitability and cost calculation"
	...
	Дано Я открываю основную форму документа "CalculateFinResult"
	Если появилось предупреждение Тогда
		Тогда я вызываю исключение "Не удалось открыть основную форму документа CalculateFinResult"
	Если имя текущей формы "ErrorWindow" Тогда
		Тогда я вызываю исключение "Не удалось открыть основную форму документа CalculateFinResult"
	И Я закрываю текущее окно
...
Сценарий: Открытие формы документа "Closing inventory, NCA, and cost accounts"
	...
	Дано Я открываю основную форму документа "CostCalculation"
	Если появилось предупреждение Тогда
		Тогда я вызываю исключение "Не удалось открыть основную форму документа CostCalculation"
	Если имя текущей формы "ErrorWindow" Тогда
		Тогда я вызываю исключение "Не удалось открыть основную форму документа CostCalculation"
	И Я закрываю текущее окно
...
Сценарий: Открытие формы документа "Record of financial instruments at depreciated cost"
...
Сценарий: Открытие формы документа "Recognition of financial instruments at fair value"
	...
	Дано Я открываю основную форму документа "FinancialInstrumentsRevaluation"
	Если появилось предупреждение Тогда
		Тогда я вызываю исключение "Не удалось открыть основную форму документа FinancialInstrumentsRevaluation"
	Если имя текущей формы "ErrorWindow" Тогда
		Тогда я вызываю исключение "Не удалось открыть основную форму документа FinancialInstrumentsRevaluation"
	И Я закрываю текущее окно
...
Сценарий: Открытие формы документа "Period closing operation by financial instruments"
	...
	Дано Я открываю основную форму документа "FinInstrPeriodClosingOperationIFRS"
	Если появилось предупреждение Тогда
		Тогда я вызываю исключение "Не удалось открыть основную форму документа FinInstrPeriodClosingOperationIFRS"
	Если имя текущей формы "ErrorWindow" Тогда
		Тогда я вызываю исключение "Не удалось открыть основную форму документа FinInstrPeriodClosingOperationIFRS"
	И Я закрываю текущее окно
...
Сценарий: Открытие формы документа "Intercompany transaction discrepancy settlement"

	Дано Я открываю основную форму документа "IntercompanyDiscrepanciesSettlement"
	Если появилось предупреждение Тогда
		Тогда я вызываю исключение "Не удалось открыть основную форму документа IntercompanyDiscrepanciesSettlement"
	Если имя текущей формы "ErrorWindow" Тогда
		Тогда я вызываю исключение "Не удалось открыть основную форму документа IntercompanyDiscrepanciesSettlement"
	И Я закрываю текущее окно
...
Сценарий: Открытие формы документа "Revaluation of currency assets and liabilities"
	...
	Дано Я открываю основную форму документа "RevaluationOfForeignCurrAssetsAndLiabilities"
	Если появилось предупреждение Тогда
		Тогда я вызываю исключение "Не удалось открыть основную форму документа RevaluationOfForeignCurrAssetsAndLiabilities"
	Если имя текущей формы "ErrorWindow" Тогда
		Тогда я вызываю исключение "Не удалось открыть основную форму документа RevaluationOfForeignCurrAssetsAndLiabilities"
	И Я закрываю текущее окно
