...
Сценарий: Открытие формы отчета "Document register records"
	...
	Дано Я открываю основную форму отчета "CustomStatementMovements"
	Если появилось предупреждение Тогда
		Тогда я вызываю исключение "Не удалось открыть основную форму отчета CustomStatementMovements"
	Если имя текущей формы "ErrorWindow" Тогда
		Тогда я вызываю исключение "Не удалось открыть основную форму отчета CustomStatementMovements"
	И Я закрываю текущее окно
...
Сценарий: Открытие формы отчета "Indicator tree"
	...
	Дано Я открываю основную форму отчета "IndicatorsTree"
	Если появилось предупреждение Тогда
		Тогда я вызываю исключение "Не удалось открыть основную форму отчета IndicatorsTree"
	Если имя текущей формы "ErrorWindow" Тогда
		Тогда я вызываю исключение "Не удалось открыть основную форму отчета IndicatorsTree"
	И Я закрываю текущее окно
...
Сценарий: Открытие формы отчета "Network diagram of universal process template"
	...
	Дано Я открываю основную форму отчета "NetworkDiagramOfUniProcessTemplate"
	Если появилось предупреждение Тогда
		Тогда я вызываю исключение "Не удалось открыть основную форму отчета NetworkDiagramOfUniProcessTemplate"
	Если имя текущей формы "ErrorWindow" Тогда
		Тогда я вызываю исключение "Не удалось открыть основную форму отчета NetworkDiagramOfUniProcessTemplate"
	И Я закрываю текущее окно
